...
@section('pageTitle', 'profile Management')

@section('actionBar')
    <a href="{{ route('admin.profile.detail','add') }}" class="btn btn-outline btn-info pull-right m-l-20 waves-effect waves-light">Add</a>
@endSection
...
<div class="col-sm-12">
    <div class="panel panel-info">
        <div class="panel-wrapper collapse in" aria-expanded="true">
            ...
            <h3 class="box-title m-b-0 black">Table profile</h3>
            <hr>
                ...
                <table id="myTable" class="table table-striped">
                    ...
                    @foreach($profiles as $profile)
                        <tr>
                            ...
                            <td>{{$profile->nrp}}</td>
                            <td>{{$profile->nama}}</td>
                            <td><img src="{{asset('storage/'.$profile->foto)}}" height="50"/></td>
                            <td>{{$profile->prodi}}</td>
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <a href="{{ route('admin.profile.detail',$profile->id) }}" name="edit_id" value="{{$profile->id}}">
                                ...
                                <div class="col-md-2">
                                    <form method="POST" action="{{route('admin.profile.delete', $profile->id)}}">
                                        @csrf
                                        @method('DELETE')
